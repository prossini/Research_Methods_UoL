...
```{r}
df <- read_sav("~/OneDrive - The University of Liverpool/Teaching/COMM747 Research Methods/Datasets/American Trends Pew/ATP W74.sav")
```
...
This dataset comes with a PDF file that contains the survey questions and their "labels", which are the column names you will see in R. When working with this type of survey, you should always keep the PDF open to refer to the correct columns.
